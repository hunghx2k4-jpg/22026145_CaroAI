...
Đồ án thực hành môn học Trí tuệ Nhân tạo nhóm sinh viên thực hiện xây dựng trò chơi cờ Caro đối kháng trực quan giữa Người và Máy tính (AI).

📌 Thành viên nhóm thực hiện

Thành viên 1: Đào Duy Hưng - MSSV: 22026145

📂 Cấu trúc thư mục Repository

Thư mục dự án được tổ chức đồng bộ và chuẩn hóa như sau:
...
git clone [https://github.com/](https://github.com/)[Tên_Tài_Khoản]/mssv1_mssv2_mssv3_CaroAI.git
cd mssv1_mssv2_mssv3_CaroAI
